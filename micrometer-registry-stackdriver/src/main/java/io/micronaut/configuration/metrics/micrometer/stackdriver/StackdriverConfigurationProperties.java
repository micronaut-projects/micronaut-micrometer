 ...
 * @see StackdriverConfig
 * @since 1.2.0
 */
@ConfigurationProperties(MICRONAUT_METRICS_EXPORT)
public class StackdriverConfigurationProperties implements StackdriverConfig {
     ...
     */
    public StackdriverConfigurationProperties(Environment environment) {
