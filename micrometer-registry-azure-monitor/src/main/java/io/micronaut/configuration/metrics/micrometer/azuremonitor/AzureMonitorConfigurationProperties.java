 ...
 * @see AzureMonitorConfig
 * @since 1.2.0
 */
@ConfigurationProperties(MICRONAUT_METRICS_EXPORT)
public class AzureMonitorConfigurationProperties implements AzureMonitorConfig {
     ...
     */
    public AzureMonitorConfigurationProperties(Environment environment) {
